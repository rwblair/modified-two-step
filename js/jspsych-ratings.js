/*
Adding in a rating plugin
Modeled this after Sam Zorowitz's comprehension check
Lynde Folsom 
*/

jsPsych.plugins['two-step-rating'] = (function() {
    var plugin = {};
  
    plugin.info = {
      name: 'two-step-rating',
      description: '',
      parameters: {
        prompts: {
          ...
          array: true,
          pretty_name: 'Prompts',
          description: 'Rating questions'
        },
        options: {
          type: jsPsych.plugins.parameterType.HTML_STRING,
          array: true,
          pretty_name: 'Options',
          description: 'Rating check question options'
        },
    ...
    plugin.trial = function(display_element, trial) {
      ...
      // Plug-in setup
      var plugin_id_name = "plugin-html-slider-response.js";
      ...
      html += '<div class="jspsych-rating-preamble"><h4>To continue, you must answer the following:</h4></div>';
  
      // Initialize form element
      html += '<form id="jspsych-rating-form">';
      ...
      document.querySelector('form').addEventListener('submit', function(event) {
        ...
        for (var i=0; i<trial.prompts.length; i++) {
          ...
          var match = display_element.querySelector('two-step-rating',+i);
